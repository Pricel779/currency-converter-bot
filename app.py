...
def main():
    ...
    application.add_handler(CallbackQueryHandler(button))  # Инлайн-кнопки
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, keyboard_handler))  # Кнопки клавиатуры
